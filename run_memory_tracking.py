...
if __name__ == '__main__':
    if use_case_choice_metric == "Mycobot":
        run_all_algs.run_filprofiler_memory_tracking(datasets.expt_config_mycobot_fourjoints_3000, memory_filename, alg_choice, alg_params1, alg_params2)

    if use_case_choice_metric == "Turtlebot_TB1":
        run_all_algs.run_filprofiler_memory_tracking(datasets.expt_config_turtlebot_multi_tb1_server_allops, memory_filename, alg_choice, alg_params1, alg_params2)

    if use_case_choice_metric == "Turtlebot_TB2":
        run_all_algs.run_filprofiler_memory_tracking(datasets.expt_config_turtlebot_multi_tb2_server_allops, memory_filename, alg_choice, alg_params1, alg_params2)

    if use_case_choice_metric == "ETerry_Human1":
        run_all_algs.run_filprofiler_memory_tracking(datasets.expt_config_eterry_human1_15files, memory_filename, alg_choice, alg_params1, alg_params2)

    if use_case_choice_metric == "ETerry_StaticHumans":
        run_all_algs.run_filprofiler_memory_tracking(datasets.expt_config_eterry_statichumans_15files, memory_filename, alg_choice, alg_params1, alg_params2)

    if use_case_choice_metric == "ETerry_PathCompletion":
        run_all_algs.run_filprofiler_memory_tracking(datasets.expt_config_eterry_pathcompletion_15files, memory_filename, alg_choice, alg_params1, alg_params2)
