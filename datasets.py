...
################################################################################
data_dir_base_eterry_human1_15files = "./input_csv_data/eterry-15files-human1"
data_dir_base_eterry_statichumans_15files = "./input_csv_data/eterry-15files-statichumans"
data_dir_base_eterry_pathcompletion_15files = "./input_csv_data/eterry-15files-pathcompletion"

eterry_ops = ["deletePointCloud", "delayPointCloud", "changeHumanXStep_zero", "humanPos2Offset", "humanPos3Offset"]

expt_config_eterry_human1_15files = {
    "dataset_name" : "ETERRY-Human1Dist",
    "data_dir_base" : data_dir_base_eterry_human1_15files,
...
expt_config_eterry_statichumans_15files = {
    ...
    "data_dir_base" : data_dir_base_eterry_statichumans_15files,
...
expt_config_eterry_pathcompletion_15files = {
    ...
    "data_dir_base" : data_dir_base_eterry_pathcompletion_15files,
