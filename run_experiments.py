...
if __name__ == '__main__':
    ...
    if run_mycobot:
        run_all_algs.run_all_algs_on_dataset(datasets.expt_config_mycobot_fourjoints_bothmetrics_objectposition, using_inceptiontime=False, run_non_intervals=True, run_intervals=False)
        run_all_algs.run_all_algs_on_dataset(datasets.expt_config_mycobot_fourjoints_bothmetrics_parammag, using_inceptiontime=False, run_non_intervals=True, run_intervals=False)
